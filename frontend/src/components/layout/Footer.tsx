                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                <div className="font-bold text-xl text-white">RECURIGHT</div>
                                <div className="text-xs text-gray-400">Professional Recruitment</div>
                            </div>
                        </div>
                        <p className="text-sm text-gray-400 mb-4">
                            Connecting talent with opportunity across Ethiopia and beyond.
                        </p>
                        {/* Social Links */}
                ...
                <div className="pt-8 border-t border-slate-800">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-sm text-gray-400">
                            © {currentYear} RECURIGHT Professional Recruitment Solutions Plc. All rights reserved.
                        </p>
                        <div className="flex items-center space-x-4 text-sm text-gray-400">
                            <span>📧 info@recuright.com</span>
